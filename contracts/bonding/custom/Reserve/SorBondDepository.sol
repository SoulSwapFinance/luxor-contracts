...
contract SorBondDepository is Ownable {
    ...
    address public immutable principle = 0xEFFd4874AcA3Acd19a24dF3281b5cdAdD823801A; // SOR token used to create bond
    ...
    address public immutable bondCalculator = 0x0000000000000000000000000000000000000000; // calculates value of LP tokens
    ...
    function setBondTerms ( PARAMETER _parameter, uint _input ) external onlyPolicy() {
        if ( _parameter == PARAMETER.VESTING ) { // 0
            require( _input >= 129_600, "Vesting must be longer than 36 hours" );
