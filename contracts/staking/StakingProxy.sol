...
contract StakingProxy is Ownable {
    ...
    address public immutable LUX = 0x6671E20b83Ba463F270c8c75dAe57e3Cc246cB2b;
    address public immutable LUM = 0x4290b33158F429F40C0eDc8f9b9e5d8C5288800c;
    address public manager;
    address public immutable staking = 0xf3F0BCFd430085e198466cdCA4Db8C2Af47f0802;
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        require(_amount != 0); // why would anyone need to stake 0 LUX?
        ...
        claims[_recipient] = Claim({
            ...
            gons: claimInfo.gons.add(ILUM(LUM).gonsForBalance(_amount)),
    ...
    function claim(address _recipient) public {
        ...
        IERC20(LUM).transfer(_recipient, ILUM(LUM).balanceForGons(claimInfo.gons));
    }
