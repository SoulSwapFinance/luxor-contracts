...
contract StakingManager is Ownable {
    ...
    address public LUM = 0x4290b33158F429F40C0eDc8f9b9e5d8C5288800c;
    address public staking = 0xf3F0BCFd430085e198466cdCA4Db8C2Af47f0802;
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        IERC20(LUX).safeTransferFrom(msg.sender, targetProxy, _amount);
    ...
    function setLuxor( address _LUX ) external onlyPolicy() {
